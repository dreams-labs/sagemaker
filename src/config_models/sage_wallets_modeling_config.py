...
class TrainingConfig(NoExtrasBaseModel):
    ...
    custom_filters: Optional[dict] = Field(default=None)
    drop_patterns: Optional[List[str]] = Field(default=None)
    protected_columns: Optional[List[str]] = Field(default=None)
